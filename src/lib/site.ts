export const site = {
  ...
  description:
    "Plataforma de inteligencia de mercado para exportadores chilenos de productos del mar.",
...
export const ctas = {
  trial: { label: "Crear cuenta gratis", href: "/demo?intent=trial" },
  demo: { label: "Solicita una demo de 15 min", href: "/demo" },
} as const;
